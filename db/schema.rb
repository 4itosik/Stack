...
ActiveRecord::Schema.define(version: 20150819084928) do
  ...
  add_index "authorizations", ["confirmation"], name: "index_authorizations_on_confirmation", using: :btree
  ...
  add_index "subscribes", ["user_id", "question_id"], name: "index_subscribes_on_user_id_and_question_id", unique: true, using: :btree
